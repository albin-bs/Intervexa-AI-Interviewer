    ...
    >
      ...
      <div className="grid grid-cols-2 gap-4 mb-4">
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 p-4 text-white transition-all rounded-lg bg-slate-800 hover:bg-slate-700"
        >
      ...
      <div className="mb-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <input
            ...
            className="flex-1 h-2 rounded-lg appearance-none cursor-pointer bg-slate-800 accent-emerald-500"
            style={{
        ...
        >
          ...
          <div className="flex gap-3">
            <button
              ...
              className="flex items-center justify-center flex-1 gap-2 p-3 text-white transition-all rounded-lg bg-slate-800 hover:bg-slate-700"
            >
            ...
            <button
              ...
              className="p-3 text-white transition-all rounded-lg bg-emerald-600 hover:bg-emerald-500"
